...
import edu.kosmo.hjs.vo.PagingVO;
...
public class RestBoardController {
	...
	@GetMapping("/axios/{bid}")
	public ResponseEntity<BoardVO> getBoard(@PathVariable("bid") int bid) {
		log.info("get: " + bid);
		return new ResponseEntity<>(boardService.get(bid), HttpStatus.OK);	
